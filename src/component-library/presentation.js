...
Keep Teams Aligned
      ...
      <Slide>
        <Heading size={1} fit>
Spectrum of Tools &amp; Processes
        </Heading>
      </Slide>

      <Slide>
        <Heading size={1} fit>
Styleguide/Design Spec
        </Heading>

        <List>
          <Appear>
            <ListItem>
Defines visual/interaction design details and usage guidelines
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
...
Familiar with these tools?
          ...
          <Appear>
            <ListItem>
Have a design spec or style guide?
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
Have an interactive component library?
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
Have a functional prototype?
          ...
          <Appear>
            <ListItem>
Share code in component library/prototype & production?
            </ListItem>
          </Appear>
        </List>
      </Slide>
      ...
      <Slide>
        <Heading size={1} fit style={{padding: '0 0 20px 0'}}>
Encouraging Collaboration
        </Heading>
        <Heading size={3} textColor="#888">
Agile Manifesto
        </Heading>
...
Outline
        ...
        <List>
          <Appear>
            <ListItem>
Why our best attempts often fail
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
Early problems in our new app at Dwolla
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
Rallying around components
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
          ...
          <Appear>
            <ListItem>
              ...
              <List style={{marginLeft: 50}}>
                <Appear>
                  <ListItem>
Design team makes updates based on new findings
                  </ListItem>
                </Appear>
                <Appear>
                  <ListItem>
          ...
          <Appear>
            <ListItem>
              ...
              <List style={{marginLeft: 50}}>
                <Appear>
                  <ListItem>
PO typically is not clear on what the design team considers important
                  </ListItem>
                </Appear>
              </List>
            </ListItem>
...
Fingerpointing
      ...
      <Slide>
        <Heading size={1} fit>
Some Background on Dwolla’s Approach to
        </Heading>
        <Heading size={2} fit>
Front-End Development
        ...
        <List>
          <Appear>
            <ListItem>
Traditionally, engineering handled back-end development
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
Front-end work mostly handed off to the design team
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
      ...
      <Slide>
        <Heading size={1} fit>
Regained Focus on Front-End
        </Heading>

        <List>
          <Appear>
            <ListItem>
Recently prioitized a new web app to support our API partners
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
      ...
      <Slide>
        <Heading size={1} fit>
Already Seeing the Same Problems
        </Heading>
...
React + css modules
          ...
          <Appear>
            <ListItem>
              Desire from management to share
              {' '}
              <Code textColor="#888">
scss
              </Code>
...
Fingerpointing
      ...
      <Slide>
        <Heading size={1} fit>
Align Around Components
        </Heading>
        <Heading size={2} textColor="#888" fit>
Rather than place blame, find a way to improve
        </Heading>
      </Slide>
...
Pattern Lab
        ...
        <Link textColor="#888" href="http://demo.patternlab.io/" target="_blank">
http://demo.patternlab.io/
      ...
      <Slide>
        <Heading size={1} fit>
Engineering Approach to Components
        </Heading>
        <Heading size={3} fit textColor="#888" textFont="primary">
Modularity is Foundational
        </Heading>
          ...
          <Appear>
            <ListItem>
              ...
              <List style={{marginLeft: 50}}>
                <Appear>
                  <ListItem>
Namespacing of style rules to a single component
                  </ListItem>
                </Appear>
              </List>
            </ListItem>
...
CSS Modules
        ...
        <Heading size={3} fit textColor="#888" textFont="primary">
Namespace CSS rules to a single component
        </Heading>
...
Not Quite
        ...
        <List>
          <Appear>
            <ListItem>
Prototype and production app are separate implementations
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
              ...
              <List style={{marginLeft: 50}}>
                <Appear>
                  <ListItem>
Management was confident that this would significantly improve velocity
                  </ListItem>
                </Appear>
                <Appear>
                  <ListItem>
Hesitation to give up ownership of styles
                  </ListItem>
                </Appear>
                <Appear>
                  <ListItem>
Quickly became difficult because of diverging markup
                  </ListItem>
                </Appear>
              </List>
            </ListItem>
          ...
          <Appear>
            <ListItem>
Team was learning and updating previous decisions
            </ListItem>
          </Appear>
        </List>
      </Slide>
...
Misaligned Priorities
        ...
        <List>
          <Appear>
            <ListItem>
Design team far ahead
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
Once an engineering priority, many decisions already made without input
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
...
A chance of success
      ...
      <Slide>
        <Heading size={1} fit>
Realignment on Componentization
        </Heading>
      </Slide>
...
Comprehensive Documentation
        ...
        <List>
          <Appear>
            <ListItem>
Details that aren’t in the production implementation are a form of documentation
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
Whether a design spec, style guide, component library, or prototype
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
If it needs to be translated to production code, details can and will be lost
            </ListItem>
          </Appear>
        </List>
      </Slide>
...
Get Over the Traditional
        ...
        <Heading size={1} fit>
Separation-of-Concerns Mentality
        </Heading>

        <List>
          <Appear>
            <ListItem>
stop separating by technology
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
          ...
          <Appear>
            <ListItem>
              ...
              <List style={{marginLeft: 50}}>
                <Appear>
                  <ListItem>
Code that changes together should be packaged together
                  </ListItem>
                </Appear>
                <Appear>
                  <ListItem>
Improve chances of dead code removal
                  </ListItem>
                </Appear>
              </List>
            </ListItem>
...
should be packaged together
        ...
        <Appear>
          <CodePane lang="bash" source={require('../../assets/component-tree.example')} />
        </Appear>

        <List>
          <Appear>
            <ListItem>
far simpler to coordinate changes than when packaged separately
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
Also simplifies removal of dead code (styles) when sunsetting a component
            </ListItem>
          </Appear>
        </List>
      </Slide>
      ...
      <Slide>
        <Heading size={1} fit style={{padding: 10}}>
Isolate the Components
        ...
        <Text textColor="secondary" style={{margin: 50}}>
...
Storybook Addons
        ...
        <Heading size={3} textColor="#888" textFont="primary">
Info Addon
        </Heading>
...
Storybook Fit
        ...
        <List>
          <Appear>
            <ListItem>
Great job demoing components in isolation
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
Encourages pure components
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
...
function to log events
          ...
          <Appear>
            <ListItem>
Supports hot-reload for quick development iteration
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
...
: Does not yet support hierarchy, so unable to structure like Atomic Design
            </ListItem>
          </Appear>
        </List>
      </Slide>
          ...
          <Appear>
            <ListItem>
              ...
              <List style={{marginLeft: 50}}>
                <Appear>
                  <ListItem>
Engineering practices, code structure, refactoring
                  </ListItem>
                </Appear>
                <Appear>
                  <ListItem>
Alignment to design goals
                  </ListItem>
                </Appear>
              </List>
            </ListItem>
...
Reviews
        ...
        <List>
          <Appear>
            <ListItem>
Reviewing code often simple enough through the web interface
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
...
Publish
        ...
        <Heading size={3} fit textColor="#888" textFont="primary">
Now we need to get the code into the apps
        </Heading>
      </Slide>
...
Scoped Packages
        ...
        <List>
          <Appear>
            <ListItem>
Don’t pollute the global namespace if you don’t expect broad package use
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
...
npm version
            ...
            <List>
              <Appear>
                <ListItem>
provides info about the current version
                </ListItem>
              </Appear>
            </List>
          </div>
...
npm version (major|minor|patch)
            ...
            <List>
              <Appear>
                <ListItem>
Increments version based on semver
                </ListItem>
              </Appear>
              <Appear>
                <ListItem>
Commits the verion bump
                </ListItem>
              </Appear>
              <Appear>
                <ListItem>
...
npm publish
        ...
        <List>
          <Appear>
            <ListItem>
Publishes current version to the registry
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
...
: Configue CI server to do this step
              <List style={{marginLeft: 50}}>
                <Appear>
                  <ListItem>
                    Even removes the need to have a token in your
                    {' '}
                    <Code textColor="#888">
~/.npmrc
                    </Code>
...
npm login
                ...
                <Appear>
                  <ListItem>
                    <Link textColor="#888" target="_blank" href={npmPublishExampleLink}>
Example
                    </Link>
                  </ListItem>
                </Appear>
...
preversion
                  ...
                  {' '}
to run your tests &amp; other verification
                </ListItem>
              </Appear>
            </List>
          </div>
...
Example Scripts
      ...
      <Slide>
        <Heading size={1} fit>
Doesn’t this make it harder to see how the
        </Heading>
        <Heading size={1} fit>
components work in the context of your app?
        </Heading>
      </Slide>
...
Yes
        ...
        <Heading size={3} textColor="#888" textFont="primary" fit>
But we don’t have to be satisfied with that
        </Heading>
      </Slide>

      <Slide>
        <Heading size={1} fit>
          Depending on versions not in
          {' '}
          <Code textColor="secondary" textSize="1.66rem">
master
          </Code>
        </Heading>
...
npm link
                  ...
                  {' '}
to make it available for linking
                </ListItem>
              </Appear>
              <Appear>
                <ListItem>
...
npm link @scope/package-name
              ...
              <Appear>
                <ListItem>
Enable a watcher to build package when changed
                </ListItem>
              </Appear>
              <Appear>
                <ListItem>
...
Webpack Gotcha
        ...
        <List>
          <Appear>
            <ListItem>
npm packages use their own local dependency tree
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
webpack loaders get confused w/o additional config
            </ListItem>
          </Appear>
        </List>

        <Appear>
          <CodePane lang="js" source={require('../../assets/resolve-loader.example')} />
        </Appear>
      </Slide>
...
Webpack Painpoint
        ...
        <List>
          <Appear>
            <ListItem>
Powerful and works well once configured appropriately
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
Even the smallest config change can take significant effort to understand
            </ListItem>
          </Appear>
        </List>
      </Slide>
...
Still a work in progress
        ...
        <List>
          <Appear>
            <ListItem>
Solved the technical hurdles
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
Making good progress on process and collaboration
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
              ...
              <List style={{marginLeft: 50}}>
                <Appear>
                  <ListItem>
Not sure what pain points will arise with WIP design changes
                  </ListItem>
                </Appear>
                <Appear>
                  <ListItem>
Confident it will encourage collabaration rather than working in silos
                  </ListItem>
                </Appear>
              </List>
            </ListItem>
          ...
          <Appear>
            <ListItem>
Hoping to make our component library public
            </ListItem>
          </Appear>
        </List>
      </Slide>
...
matt.travi.org
              ...
              <ListItem>
                <Link textColor="#888" target="_blank" href="https://github.com/travi">
github.com/travi
                </Link>
              </ListItem>
              <ListItem>
