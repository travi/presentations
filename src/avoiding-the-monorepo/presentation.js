...
Undeniable benefits
          ...
          <Appear>
            <ListItem>
Account for costs when splitting
            </ListItem>
          </Appear>
        </List>
      </Slide>
...
Unpublished changes
          ...
          <Appear>
            <ListItem>
Published versions not yet consumed
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
Duplication of decisions/implementations
            </ListItem>
          </Appear>
        </List>
      </Slide>
...
Management Options
        ...
        <List>
          <Appear>
            <ListItem>
node.js/npm are well suited for extreme modularity
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
Repositories 1:1 for npm packages
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
Monorepos that version many npm packages
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
I consider monorepos to be a symptom
            </ListItem>
          </Appear>
        </List>
      </Slide>
...
Yeoman
        ...
        <List>
          <Appear>
            <ListItem>
De facto standard generator for JavaScript projects
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
          ...
          <Appear>
            <ListItem>
Ended up not fitting how I wanted to compose generators
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
              So, I&apos;m now building&nbsp;
              <Link textColor="black" href="https://github.com/travi/project-scaffolder">
...
Isolate Updates
          ...
          <Appear>
            <ListItem>
Automate Updates (if you have enough confidence)
            </ListItem>
          </Appear>
          <Appear>
            <ListItem>
...
twitter.com/mtravi
          ...
          <ListItem>
            <Link textColor="white" target="_blank" href="https://presentations.travi.org/avoiding-the-monorepo">
              presentations.travi.org/avoiding-the-monorepo
            </Link>
          </ListItem>
        </List>
      </Slide>
